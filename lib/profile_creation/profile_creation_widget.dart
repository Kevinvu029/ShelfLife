                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (selectedMedia != null &&
                        ...
                        safeSetState(
                            () => _model.isDataUploading_uploadDataKrd = true);
                        ...
                        try {
                          ...
                          _model.isDataUploading_uploadDataKrd = false;
                        }
                        if (selectedUploadedFiles.length ==
                                selectedMedia.length &&
                            downloadUrls.length == selectedMedia.length) {
                          safeSetState(() {
                            _model.uploadedLocalFile_uploadDataKrd =
                                selectedUploadedFiles.first;
                            _model.uploadedFileUrl_uploadDataKrd =
                                downloadUrls.first;
                          });
                        } else {
                          safeSetState(() {});
                      ...
                      await currentUserReference!.update(createUsersRecordData(
                        photoUrl: _model.uploadedFileUrl_uploadDataKrd,
                      ));
                    },
                    child: Stack(
