...
import 'acc_model.dart';
export 'acc_model.dart';

class AccWidget extends StatefulWidget {
  const AccWidget({super.key});

  static String routeName = 'acc';
  static String routePath = '/acc';

  @override
  State<AccWidget> createState() => _AccWidgetState();
}

class _AccWidgetState extends State<AccWidget> with TickerProviderStateMixin {
  late AccModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'acc'});
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'ACC_PAGE_GET_STARTED_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'ACC_PAGE_CONTINUE_WITH_GOOGLE_BTN_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Button_auth');
                                                                        GoRouter.of(context)
                                                                            .prepareAuthEvent();
                                                                  ...
                                                                  isAndroid
                                                                      ...
                                                                      : Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('ACC_PAGE_CONTINUE_WITH_APPLE_BTN_ON_TAP');
                                                                ...
                                                                : Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'ACC_PAGE_CONTINUE_WITH_APPLE_BTN_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Button_auth');
                                                                        GoRouter.of(context)
                                                                            .prepareAuthEvent();
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'ACC_PAGE_FORGOT_PASSWORD_BTN_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Button_auth');
                                                              GoRouter.of(
                                                                      context)
                    ...
                    children: [
                      Align(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/images/Gemini_Generated_Image_r7rener7rener7re-Picsart-BackgroundRemover.png',
                            width: 70.0,
                            height: 70.0,
                            fit: BoxFit.cover,
