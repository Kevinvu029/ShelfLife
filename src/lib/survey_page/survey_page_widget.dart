...
/// Create a survey page that asks the user to rate their current experience
/// 0-5 as well as ask for any feedback or suggestions in a box.
///
/// At the top make sure to have the words Survey
class SurveyPageWidget extends StatefulWidget {
  const SurveyPageWidget({super.key});

  static String routeName = 'SurveyPage';
  static String routePath = '/surveyPage';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SURVEY_arrow_back_rounded_ICN_ON_TAP');
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Help us improve by sharing your experience. This will only take a minute.',
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Tell us what you think or how we can do better.',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.darumadropOne(
                                fontWeight: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  'Share your thoughts, ideas, or suggestions here...',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FlutterFlowRadioButton(
                          options: ['Yes, definitely!', 'Maybe', 'No'].toList(),
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SURVEY_SUBMIT_SURVEY_BTN_ON_TAP');
                      if (valueOrDefault<bool>(
                        ...
                        await UserFeedBackRecord.collection
                            ...
                            .set(createUserFeedBackRecordData(
                              ...
                              reccomendation: _model.radioButtonValue,
                              surveySubmitted: true,
                              ratingSelected: _model.ratingBarValue?.round(),
                            ));
